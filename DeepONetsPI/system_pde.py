...
class LTSystem(object):
    ...
    def gen_operator_data(self, space, m, num):
        ...
        return [sensor_values_tile, ns], s_values, sensors
...
class ODESystem(object):
    ...
    def gen_operator_data(self, space, m, num):
        ...
        return [sensor_values, x], y, sensors
...
class DRSystem(object):
    ...
    def gen_operator_data(self, space, m, num):
        ...
        return [res[:, :m], res[:, m:-1]], res[:, -1:], sensors
...
class CVCSystem(object):
    ...
    def gen_operator_data(self, space, m, num):
        ...
        sensor_values = space.eval_u(features, sensors) # input data restriction leads to weird inference results
        # Case II Input: x*V(x)
